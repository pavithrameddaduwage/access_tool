...
let RolesController = class RolesController {
    ...
    async updateWebtool(id, updateRoleDto) {
        const role = await this.rolesService.getRoleById(id);
        if (!role) {
            throw new common_1.NotFoundException(`Role with ID ${id} not found.`);
        }
...
__decorate([
    (0, common_1.Get)('webtool/:webtoolId'),
    __param(0, (0, common_1.Param)('webtoolId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], RolesController.prototype, "getRolesByWebtool", null);
__decorate([
    (0, common_1.Post)(),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], RolesController.prototype, "updateWebtool", null);
__decorate([
