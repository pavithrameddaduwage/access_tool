...
let GroupsService = class GroupsService {
    ...
    async create(createGroupDto) {
        ...
        if (existingGroup) {
            throw new common_1.ConflictException(`Group "${createGroupDto.group}" already exists`);
        }
    ...
    async update(id, updateGroupDto) {
        if (updateGroupDto.group) {
            ...
            if (existingGroup && existingGroup.id !== id) {
                throw new common_1.ConflictException(`Group "${updateGroupDto.group}" already exists`);
            }
        }
