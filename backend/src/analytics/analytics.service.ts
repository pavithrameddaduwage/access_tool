...
//     .getRawMany();
// }
// async getLoginsByHour(webtool?: string, email?: string): Promise<{ hour: number; count: number }[]> {
//   const query = this.loginEventRepository.createQueryBuilder('login')
...
// async getLoginsByDayOfWeek(webtool?: string, email?: string): Promise<{ day: number; count: number }[]> {
//   const query = this.loginEventRepository.createQueryBuilder('login')
