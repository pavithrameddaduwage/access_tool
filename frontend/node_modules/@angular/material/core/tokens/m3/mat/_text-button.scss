...
@function get-tokens($systems, $exclude-hardcoded, $token-slots) {
  $tokens: ((
    horizontal-padding: token-definition.hardcode(12px, $exclude-hardcoded),
    with-icon-horizontal-padding: token-definition.hardcode(16px, $exclude-hardcoded),
    icon-spacing: token-definition.hardcode(8px, $exclude-hardcoded),
    icon-offset: token-definition.hardcode(-4px, $exclude-hardcoded),
