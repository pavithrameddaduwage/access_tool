...
@function values($deps: $_default, $exclude-hardcoded-values: false) {
  @return (
    ...
    // Tokens md.comp.outlined-select.menu.list-item.label-text.tracking cannot be represented
    ...
    // Warning: risk of reduced fidelity from using this composite typography token.
    // Tokens md.comp.outlined-select.text-field.input-text.tracking cannot be represented in
    ...
    'text-field-label-text-tracking':
      map.get($deps, 'md-sys-typescale', 'body-large-tracking'),
    // Warning: risk of reduced fidelity from using this composite typography token.
    // Tokens md.comp.outlined-select.text-field.label-text.tracking cannot be represented in
    // the "font" property shorthand. Consider using the discrete properties instead.
    ...
    // Warning: risk of reduced fidelity from using this composite typography token.
    // Tokens md.comp.outlined-select.text-field.supporting-text.tracking cannot be represented
    // in the "font" property shorthand. Consider using the discrete properties instead.
