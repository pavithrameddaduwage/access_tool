...
const add_ng2_charts_provider_1 = require("./steps/add-ng2-charts-provider");
/**
...
function ngAddSetupProject(options) {
    return (0, schematics_1.chain)([(0, add_ng2_charts_provider_1.addChartsProviderToMain)(options)]);
}
