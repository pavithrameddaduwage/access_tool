...
`);function Ee(e,t){return e[t++]|e[t++]<<8|e[t++]<<16|e[t++]<<24}function xe(e,t,n){e[n++]=t,e[n++]=t>>8,e[n++]=t>>16,e[n++]=t>>24}var V=JSON.stringify,ke="warning",$e="silent";function Me(e){if(G(e,"target"),e.indexOf(",")>=0)throw new Error(`Invalid target: ${e}`);return e}var me=()=>null,W=e=>typeof e=="boolean"?null:"a boolean",y=e=>typeof e=="string"?null:"a string",ye=e=>e instanceof RegExp?null:"a RegExp object",le=e=>typeof e=="number"&&e===(e|0)?null:"an integer",Pe=e=>typeof e=="function"?null:"a function",K=e=>Array.isArray(e)?null:"an array",ee=e=>typeof e=="object"&&e!==null&&!Array.isArray(e)?null:"an object",Ve=e=>typeof e=="object"&&e!==null?null:"an array or an object",Ye=e=>e instanceof WebAssembly.Module?null:"a WebAssembly.Module",Ce=e=>typeof e=="object"&&!Array.isArray(e)?null:"an object or null",Fe=e=>typeof e=="string"||typeof e=="boolean"?null:"a string or a boolean",Je=e=>typeof e=="string"||typeof e=="object"&&e!==null&&!Array.isArray(e)?null:"a string or an object",Ge=e=>typeof e=="string"||Array.isArray(e)?null:"a string or an array",Te=e=>typeof e=="string"||e instanceof Uint8Array?null:"a string or a Uint8Array",Qe=e=>typeof e=="string"||e instanceof URL?null:"a string or a URL";function r(e,t,n,i){let u=e[n];if(t[n+""]=!0,u===void 0)return;let l=i(u);if(l!==null)throw new Error(`${V(n)} must be ${l}`);return u}function Y(e,t,n){for(let i in e)if(!(i in t))throw new Error(`Invalid option ${n}: ${V(i)}`)}function De(e){let t=Object.create(null),n=r(e,t,"wasmURL",Qe),i=r(e,t,"wasmModule",Ye),u=r(e,t,"worker",W);return Y(e,t,"in initialize() call"),{wasmURL:n,wasmModule:i,worker:u}}function Be(e){let t;if(e!==void 0){t=Object.create(null);for(let n in e){let i=e[n];if(typeof i=="string"||i===!1)t[n]=i;else throw new Error(`Expected ${V(n)} in mangle cache to map to either a string or false`)}}return t}function he(e,t,n,i,u){let l=r(t,n,"color",W),g=r(t,n,"logLevel",y),s=r(t,n,"logLimit",le);l!==void 0?e.push(`--color=${l}`):i&&e.push("--color=true"),e.push(`--log-level=${g||u}`),e.push(`--log-limit=${s||0}`)}function G(e,t,n){if(typeof e!="string")throw new Error(`Expected value for ${t}${n!==void 0?" "+V(n):""} to be a string, got ${typeof e} instead`);return e}function Ue(e,t,n){let i=r(t,n,"legalComments",y),u=r(t,n,"sourceRoot",y),l=r(t,n,"sourcesContent",W),g=r(t,n,"target",Ge),s=r(t,n,"format",y),m=r(t,n,"globalName",y),U=r(t,n,"mangleProps",ye),P=r(t,n,"reserveProps",ye),b=r(t,n,"mangleQuoted",W),j=r(t,n,"minify",W),T=r(t,n,"minifySyntax",W),L=r(t,n,"minifyWhitespace",W),q=r(t,n,"minifyIdentifiers",W),S=r(t,n,"lineLimit",le),_=r(t,n,"drop",K),J=r(t,n,"dropLabels",K),w=r(t,n,"charset",y),p=r(t,n,"treeShaking",W),f=r(t,n,"ignoreAnnotations",W),o=r(t,n,"jsx",y),v=r(t,n,"jsxFactory",y),O=r(t,n,"jsxFragment",y),M=r(t,n,"jsxImportSource",y),E=r(t,n,"jsxDev",W),a=r(t,n,"jsxSideEffects",W),c=r(t,n,"define",ee),h=r(t,n,"logOverride",ee),C=r(t,n,"supported",ee),F=r(t,n,"pure",K),$=r(t,n,"keepNames",W),x=r(t,n,"platform",y),A=r(t,n,"tsconfigRaw",Je);if(i&&e.push(`--legal-comments=${i}`),u!==void 0&&e.push(`--source-root=${u}`),l!==void 0&&e.push(`--sources-content=${l}`),g&&(Array.isArray(g)?e.push(`--target=${Array.from(g).map(Me).join(",")}`):e.push(`--target=${Me(g)}`)),s&&e.push(`--format=${s}`),m&&e.push(`--global-name=${m}`),x&&e.push(`--platform=${x}`),A&&e.push(`--tsconfig-raw=${typeof A=="string"?A:JSON.stringify(A)}`),j&&e.push("--minify"),T&&e.push("--minify-syntax"),L&&e.push("--minify-whitespace"),q&&e.push("--minify-identifiers"),S&&e.push(`--line-limit=${S}`),w&&e.push(`--charset=${w}`),p!==void 0&&e.push(`--tree-shaking=${p}`),f&&e.push("--ignore-annotations"),_)for(let R of _)e.push(`--drop:${G(R,"drop")}`);if(J&&e.push(`--drop-labels=${Array.from(J).map(R=>G(R,"dropLabels")).join(",")}`),U&&e.push(`--mangle-props=${U.source}`),P&&e.push(`--reserve-props=${P.source}`),b!==void 0&&e.push(`--mangle-quoted=${b}`),o&&e.push(`--jsx=${o}`),v&&e.push(`--jsx-factory=${v}`),O&&e.push(`--jsx-fragment=${O}`),M&&e.push(`--jsx-import-source=${M}`),E&&e.push("--jsx-dev"),a&&e.push("--jsx-side-effects"),c)for(let R in c){if(R.indexOf("=")>=0)throw new Error(`Invalid define: ${R}`);e.push(`--define:${R}=${G(c[R],"define",R)}`)}if(h)for(let R in h){if(R.indexOf("=")>=0)throw new Error(`Invalid log override: ${R}`);e.push(`--log-override:${R}=${G(h[R],"log override",R)}`)}if(C)for(let R in C){if(R.indexOf("=")>=0)throw new Error(`Invalid supported: ${R}`);let k=C[R];if(typeof k!="boolean")throw new Error(`Expected value for supported ${V(R)} to be a boolean, got ${typeof k} instead`);e.push(`--supported:${R}=${k}`)}if(F)for(let R of F)e.push(`--pure:${G(R,"pure")}`);$&&e.push("--keep-names")}function He(e,t,n,i,u){var oe;let l=[],g=[],s=Object.create(null),m=null,U=null;he(l,t,s,n,i),Ue(l,t,s);let P=r(t,s,"sourcemap",Fe),b=r(t,s,"bundle",W),j=r(t,s,"splitting",W),T=r(t,s,"preserveSymlinks",W),L=r(t,s,"metafile",W),q=r(t,s,"outfile",y),S=r(t,s,"outdir",y),_=r(t,s,"outbase",y),J=r(t,s,"tsconfig",y),w=r(t,s,"resolveExtensions",K),p=r(t,s,"nodePaths",K),f=r(t,s,"mainFields",K),o=r(t,s,"conditions",K),v=r(t,s,"external",K),O=r(t,s,"packages",y),M=r(t,s,"alias",ee),E=r(t,s,"loader",ee),a=r(t,s,"outExtension",ee),c=r(t,s,"publicPath",y),h=r(t,s,"entryNames",y),C=r(t,s,"chunkNames",y),F=r(t,s,"assetNames",y),$=r(t,s,"inject",K),x=r(t,s,"banner",ee),A=r(t,s,"footer",ee),R=r(t,s,"entryPoints",Ve),k=r(t,s,"absWorkingDir",y),D=r(t,s,"stdin",ee),N=(oe=r(t,s,"write",W))!=null?oe:u,B=r(t,s,"allowOverwrite",W),H=r(t,s,"mangleCache",ee);if(s.plugins=!0,Y(t,s,`in ${e}() call`),P&&l.push(`--sourcemap${P===!0?"":`=${P}`}`),b&&l.push("--bundle"),B&&l.push("--allow-overwrite"),j&&l.push("--splitting"),T&&l.push("--preserve-symlinks"),L&&l.push("--metafile"),q&&l.push(`--outfile=${q}`),S&&l.push(`--outdir=${S}`),_&&l.push(`--outbase=${_}`),J&&l.push(`--tsconfig=${J}`),O&&l.push(`--packages=${O}`),w){let d=[];for(let I of w){if(G(I,"resolve extension"),I.indexOf(",")>=0)throw new Error(`Invalid resolve extension: ${I}`);d.push(I)}l.push(`--resolve-extensions=${d.join(",")}`)}if(c&&l.push(`--public-path=${c}`),h&&l.push(`--entry-names=${h}`),C&&l.push(`--chunk-names=${C}`),F&&l.push(`--asset-names=${F}`),f){let d=[];for(let I of f){if(G(I,"main field"),I.indexOf(",")>=0)throw new Error(`Invalid main field: ${I}`);d.push(I)}l.push(`--main-fields=${d.join(",")}`)}if(o){let d=[];for(let I of o){if(G(I,"condition"),I.indexOf(",")>=0)throw new Error(`Invalid condition: ${I}`);d.push(I)}l.push(`--conditions=${d.join(",")}`)}if(v)for(let d of v)l.push(`--external:${G(d,"external")}`);if(M)for(let d in M){if(d.indexOf("=")>=0)throw new Error(`Invalid package name in alias: ${d}`);l.push(`--alias:${d}=${G(M[d],"alias",d)}`)}if(x)for(let d in x){if(d.indexOf("=")>=0)throw new Error(`Invalid banner file type: ${d}`);l.push(`--banner:${d}=${G(x[d],"banner",d)}`)}if(A)for(let d in A){if(d.indexOf("=")>=0)throw new Error(`Invalid footer file type: ${d}`);l.push(`--footer:${d}=${G(A[d],"footer",d)}`)}if($)for(let d of $)l.push(`--inject:${G(d,"inject")}`);if(E)for(let d in E){if(d.indexOf("=")>=0)throw new Error(`Invalid loader extension: ${d}`);l.push(`--loader:${d}=${G(E[d],"loader",d)}`)}if(a)for(let d in a){if(d.indexOf("=")>=0)throw new Error(`Invalid out extension: ${d}`);l.push(`--out-extension:${d}=${G(a[d],"out extension",d)}`)}if(R)if(Array.isArray(R))for(let d=0,I=R.length;d<I;d++){let X=R[d];if(typeof X=="object"&&X!==null){let te=Object.create(null),Q=r(X,te,"in",y),ue=r(X,te,"out",y);if(Y(X,te,"in entry point at index "+d),Q===void 0)throw new Error('Missing property "in" for entry point at index '+d);if(ue===void 0)throw new Error('Missing property "out" for entry point at index '+d);g.push([ue,Q])}else g.push(["",G(X,"entry point at index "+d)])}else for(let d in R)g.push([d,G(R[d],"entry point",d)]);if(D){let d=Object.create(null),I=r(D,d,"contents",Te),X=r(D,d,"resolveDir",y),te=r(D,d,"sourcefile",y),Q=r(D,d,"loader",y);Y(D,d,'in "stdin" object'),te&&l.push(`--sourcefile=${te}`),Q&&l.push(`--loader=${Q}`),X&&(U=X),typeof I=="string"?m=Z(I):I instanceof Uint8Array&&(m=I)}let z=[];if(p)for(let d of p)d+="",z.push(d);return{entries:g,flags:l,write:N,stdinContents:m,stdinResolveDir:U,absWorkingDir:k,nodePaths:z,mangleCache:Be(H)}}function Xe(e,t,n,i){let u=[],l=Object.create(null);he(u,t,l,n,i),Ue(u,t,l);let g=r(t,l,"sourcemap",Fe),s=r(t,l,"sourcefile",y),m=r(t,l,"loader",y),U=r(t,l,"banner",y),P=r(t,l,"footer",y),b=r(t,l,"mangleCache",ee);return Y(t,l,`in ${e}() call`),g&&u.push(`--sourcemap=${g===!0?"external":g}`),s&&u.push(`--sourcefile=${s}`),m&&u.push(`--loader=${m}`),U&&u.push(`--banner=${U}`),P&&u.push(`--footer=${P}`),{flags:u,mangleCache:Be(b)}}function je(e){let t={},n={didClose:!1,reason:""},i={},u=0,l=0,g=new Uint8Array(16*1024),s=0,m=w=>{let p=s+w.length;if(p>g.length){let o=new Uint8Array(p*2);o.set(g),g=o}g.set(w,s),s+=w.length;let f=0;for(;f+4<=s;){let o=Ee(g,f);if(f+4+o>s)break;f+=4,L(g.subarray(f,f+o)),f+=o}f>0&&(g.copyWithin(0,f,s),s-=f)},U=w=>{n.didClose=!0,w&&(n.reason=": "+(w.message||w));let p="The service was stopped"+n.reason;for(let f in i)i[f](p,null);i={}},P=(w,p,f)=>{if(n.didClose)return f("The service is no longer running"+n.reason,null);let o=u++;i[o]=(v,O)=>{try{f(v,O)}finally{w&&w.unref()}},w&&w.ref(),e.writeToStdin(Oe({id:o,isRequest:!0,value:p}))},b=(w,p)=>{if(n.didClose)throw new Error("The service is no longer running"+n.reason);e.writeToStdin(Oe({id:w,isRequest:!1,value:p}))},j=async(w,p)=>{try{if(p.command==="ping"){b(w,{});return}if(typeof p.key=="number"){let f=t[p.key];if(!f)return;let o=f[p.command];if(o){await o(w,p);return}}throw new Error("Invalid command: "+p.command)}catch(f){let o=[ie(f,e,null,void 0,"")];try{b(w,{errors:o})}catch(v){}}},T=!0,L=w=>{if(T){T=!1;let f=String.fromCharCode(...w);if(f!=="0.24.0")throw new Error(`Cannot start service: Host version "0.24.0" does not match binary version ${V(f)}`);return}let p=Se(w);if(p.isRequest)j(p.id,p.value);else{let f=i[p.id];delete i[p.id],p.value.error?f(p.value.error,{}):f(null,p.value)}};return{readFromStdout:m,afterClose:U,service:{buildOrContext:({callName:w,refs:p,options:f,isTTY:o,defaultWD:v,callback:O})=>{let M=0,E=l++,a={},c={ref(){++M===1&&p&&p.ref()},unref(){--M===0&&(delete t[E],p&&p.unref())}};t[E]=a,c.ref(),Ze(w,E,P,b,c,e,a,f,o,v,(h,C)=>{try{O(h,C)}finally{c.unref()}})},transform:({callName:w,refs:p,input:f,options:o,isTTY:v,fs:O,callback:M})=>{let E=Le(),a=c=>{try{if(typeof f!="string"&&!(f instanceof Uint8Array))throw new Error('The input to "transform" must be a string or a Uint8Array');let{flags:h,mangleCache:C}=Xe(w,o,v,$e),F={command:"transform",flags:h,inputFS:c!==null,input:c!==null?Z(c):typeof f=="string"?Z(f):f};C&&(F.mangleCache=C),P(p,F,($,x)=>{if($)return M(new Error($),null);let A=ae(x.errors,E),R=ae(x.warnings,E),k=1,D=()=>{if(--k===0){let N={warnings:R,code:x.code,map:x.map,mangleCache:void 0,legalComments:void 0};"legalComments"in x&&(N.legalComments=x==null?void 0:x.legalComments),x.mangleCache&&(N.mangleCache=x==null?void 0:x.mangleCache),M(null,N)}};if(A.length>0)return M(ce("Transform failed",A,R),null);x.codeFS&&(k++,O.readFile(x.code,(N,B)=>{N!==null?M(N,null):(x.code=B,D())})),x.mapFS&&(k++,O.readFile(x.map,(N,B)=>{N!==null?M(N,null):(x.map=B,D())})),D()})}catch(h){let C=[];try{he(C,o,{},v,$e)}catch($){}let F=ie(h,e,E,void 0,"");P(p,{command:"error",flags:C,error:F},()=>{F.detail=E.load(F.detail),M(ce("Transform failed",[F],[]),null)})}};if((typeof f=="string"||f instanceof Uint8Array)&&f.length>1024*1024){let c=a;a=()=>O.writeFile(f,c)}a(null)},formatMessages:({callName:w,refs:p,messages:f,options:o,callback:v})=>{if(!o)throw new Error(`Missing second argument in ${w}() call`);let O={},M=r(o,O,"kind",y),E=r(o,O,"color",W),a=r(o,O,"terminalWidth",le);if(Y(o,O,`in ${w}() call`),M===void 0)throw new Error(`Missing "kind" in ${w}() call`);if(M!=="error"&&M!=="warning")throw new Error(`Expected "kind" to be "error" or "warning" in ${w}() call`);let c={command:"format-msgs",messages:ne(f,"messages",null,"",a),isWarning:M==="warning"};E!==void 0&&(c.color=E),a!==void 0&&(c.terminalWidth=a),P(p,c,(h,C)=>{if(h)return v(new Error(h),null);v(null,C.messages)})},analyzeMetafile:({callName:w,refs:p,metafile:f,options:o,callback:v})=>{o===void 0&&(o={});let O={},M=r(o,O,"color",W),E=r(o,O,"verbose",W);Y(o,O,`in ${w}() call`);let a={command:"analyze-metafile",metafile:f};M!==void 0&&(a.color=M),E!==void 0&&(a.verbose=E),P(p,a,(c,h)=>{if(c)return v(new Error(c),null);v(null,h.result)})}}}}function Ze(e,t,n,i,u,l,g,s,m,U,P){let b=Le(),j=e==="context",T=(S,_)=>{let J=[];try{he(J,s,{},m,ke)}catch(p){}let w=ie(S,l,b,void 0,_);n(u,{command:"error",flags:J,error:w},()=>{w.detail=b.load(w.detail),P(ce(j?"Context failed":"Build failed",[w],[]),null)})},L;if(typeof s=="object"){let S=s.plugins;if(S!==void 0){if(!Array.isArray(S))return T(new Error('"plugins" must be an array'),"");L=S}}if(L&&L.length>0){if(l.isSync)return T(new Error("Cannot use plugins in synchronous API calls"),"");et(t,n,i,u,l,g,s,L,b).then(S=>{if(!S.ok)return T(S.error,S.pluginName);try{q(S.requestPlugins,S.runOnEndCallbacks,S.scheduleOnDisposeCallbacks)}catch(_){T(_,"")}},S=>T(S,""));return}try{q(null,(S,_)=>_([],[]),()=>{})}catch(S){T(S,"")}function q(S,_,J){let w=l.hasFS,{entries:p,flags:f,write:o,stdinContents:v,stdinResolveDir:O,absWorkingDir:M,nodePaths:E,mangleCache:a}=He(e,s,m,ke,w);if(o&&!l.hasFS)throw new Error('The "write" option is unavailable in this environment');let c={command:"build",key:t,entries:p,flags:f,write:o,stdinContents:v,stdinResolveDir:O,absWorkingDir:M||U,nodePaths:E,context:j};S&&(c.plugins=S),a&&(c.mangleCache=a);let h=($,x)=>{let A={errors:ae($.errors,b),warnings:ae($.warnings,b),outputFiles:void 0,metafile:void 0,mangleCache:void 0},R=A.errors.slice(),k=A.warnings.slice();$.outputFiles&&(A.outputFiles=$.outputFiles.map(nt)),$.metafile&&(A.metafile=JSON.parse($.metafile)),$.mangleCache&&(A.mangleCache=$.mangleCache),$.writeToStdout!==void 0&&console.log(re($.writeToStdout).replace(/\n$/,"")),_(A,(D,N)=>{if(R.length>0||D.length>0){let B=ce("Build failed",R.concat(D),k.concat(N));return x(B,null,D,N)}x(null,A,D,N)})},C,F;j&&(g["on-end"]=($,x)=>new Promise(A=>{h(x,(R,k,D,N)=>{let B={errors:D,warnings:N};F&&F(R,k),C=void 0,F=void 0,i($,B),A()})})),n(u,c,($,x)=>{if($)return P(new Error($),null);if(!j)return h(x,(k,D)=>(J(),P(k,D)));if(x.errors.length>0)return P(ce("Context failed",x.errors,x.warnings),null);let A=!1,R={rebuild:()=>(C||(C=new Promise((k,D)=>{let N;F=(H,z)=>{N||(N=()=>H?D(H):k(z))};let B=()=>{n(u,{command:"rebuild",key:t},(z,oe)=>{z?D(new Error(z)):N?N():B()})};B()})),C),watch:(k={})=>new Promise((D,N)=>{if(!l.hasFS)throw new Error('Cannot use the "watch" API in this environment');Y(k,{},"in watch() call"),n(u,{command:"watch",key:t},z=>{z?N(new Error(z)):D(void 0)})}),serve:(k={})=>new Promise((D,N)=>{if(!l.hasFS)throw new Error('Cannot use the "serve" API in this environment');let B={},H=r(k,B,"port",le),z=r(k,B,"host",y),oe=r(k,B,"servedir",y),d=r(k,B,"keyfile",y),I=r(k,B,"certfile",y),X=r(k,B,"fallback",y),te=r(k,B,"onRequest",Pe);Y(k,B,"in serve() call");let Q={command:"serve",key:t,onRequest:!!te};H!==void 0&&(Q.port=H),z!==void 0&&(Q.host=z),oe!==void 0&&(Q.servedir=oe),d!==void 0&&(Q.keyfile=d),I!==void 0&&(Q.certfile=I),X!==void 0&&(Q.fallback=X),n(u,Q,(ue,Ne)=>{if(ue)return N(new Error(ue));te&&(g["serve-request"]=(Ie,We)=>{te(We.args),i(Ie,{})}),D(Ne)})}),cancel:()=>new Promise(k=>{if(A)return k();n(u,{command:"cancel",key:t},()=>{k()})}),dispose:()=>new Promise(k=>{if(A)return k();A=!0,n(u,{command:"dispose",key:t},()=>{k(),J(),u.unref()})})};u.ref(),P(null,R)})}}var et=async(e,t,n,i,u,l,g,s,m)=>{let U=[],P=[],b={},j={},T=[],L=0,q=0,S=[],_=!1;s=[...s];for(let p of s){let f={};if(typeof p!="object")throw new Error(`Plugin at index ${q} must be an object`);let o=r(p,f,"name",y);if(typeof o!="string"||o==="")throw new Error(`Plugin at index ${q} is missing a name`);try{let v=r(p,f,"setup",Pe);if(typeof v!="function")throw new Error("Plugin is missing a setup function");Y(p,f,`on plugin ${V(o)}`);let O={name:o,onStart:!1,onEnd:!1,onResolve:[],onLoad:[]};q++;let E=v({initialOptions:g,resolve:(a,c={})=>{if(!_)throw new Error('Cannot call "resolve" before plugin setup has completed');if(typeof a!="string")throw new Error("The path to resolve must be a string");let h=Object.create(null),C=r(c,h,"pluginName",y),F=r(c,h,"importer",y),$=r(c,h,"namespace",y),x=r(c,h,"resolveDir",y),A=r(c,h,"kind",y),R=r(c,h,"pluginData",me),k=r(c,h,"with",ee);return Y(c,h,"in resolve() call"),new Promise((D,N)=>{let B={command:"resolve",path:a,key:e,pluginName:o};if(C!=null&&(B.pluginName=C),F!=null&&(B.importer=F),$!=null&&(B.namespace=$),x!=null&&(B.resolveDir=x),A!=null)B.kind=A;else throw new Error('Must specify "kind" when calling "resolve"');R!=null&&(B.pluginData=m.store(R)),k!=null&&(B.with=tt(k,"with")),t(i,B,(H,z)=>{H!==null?N(new Error(H)):D({errors:ae(z.errors,m),warnings:ae(z.warnings,m),path:z.path,external:z.external,sideEffects:z.sideEffects,namespace:z.namespace,suffix:z.suffix,pluginData:m.load(z.pluginData)})})})},onStart(a){let c='This error came from the "onStart" callback registered here:',h=pe(new Error(c),u,"onStart");U.push({name:o,callback:a,note:h}),O.onStart=!0},onEnd(a){let c='This error came from the "onEnd" callback registered here:',h=pe(new Error(c),u,"onEnd");P.push({name:o,callback:a,note:h}),O.onEnd=!0},onResolve(a,c){let h='This error came from the "onResolve" callback registered here:',C=pe(new Error(h),u,"onResolve"),F={},$=r(a,F,"filter",ye),x=r(a,F,"namespace",y);if(Y(a,F,`in onResolve() call for plugin ${V(o)}`),$==null)throw new Error("onResolve() call is missing a filter");let A=L++;b[A]={name:o,callback:c,note:C},O.onResolve.push({id:A,filter:$.source,namespace:x||""})},onLoad(a,c){let h='This error came from the "onLoad" callback registered here:',C=pe(new Error(h),u,"onLoad"),F={},$=r(a,F,"filter",ye),x=r(a,F,"namespace",y);if(Y(a,F,`in onLoad() call for plugin ${V(o)}`),$==null)throw new Error("onLoad() call is missing a filter");let A=L++;j[A]={name:o,callback:c,note:C},O.onLoad.push({id:A,filter:$.source,namespace:x||""})},onDispose(a){T.push(a)},esbuild:u.esbuild});E&&await E,S.push(O)}catch(v){return{ok:!1,error:v,pluginName:o}}}l["on-start"]=async(p,f)=>{m.clear();let o={errors:[],warnings:[]};await Promise.all(U.map(async({name:v,callback:O,note:M})=>{try{let E=await O();if(E!=null){if(typeof E!="object")throw new Error(`Expected onStart() callback in plugin ${V(v)} to return an object`);let a={},c=r(E,a,"errors",K),h=r(E,a,"warnings",K);Y(E,a,`from onStart() callback in plugin ${V(v)}`),c!=null&&o.errors.push(...ne(c,"errors",m,v,void 0)),h!=null&&o.warnings.push(...ne(h,"warnings",m,v,void 0))}}catch(E){o.errors.push(ie(E,u,m,M&&M(),v))}})),n(p,o)},l["on-resolve"]=async(p,f)=>{let o={},v="",O,M;for(let E of f.ids)try{({name:v,callback:O,note:M}=b[E]);let a=await O({path:f.path,importer:f.importer,namespace:f.namespace,resolveDir:f.resolveDir,kind:f.kind,pluginData:m.load(f.pluginData),with:f.with});if(a!=null){if(typeof a!="object")throw new Error(`Expected onResolve() callback in plugin ${V(v)} to return an object`);let c={},h=r(a,c,"pluginName",y),C=r(a,c,"path",y),F=r(a,c,"namespace",y),$=r(a,c,"suffix",y),x=r(a,c,"external",W),A=r(a,c,"sideEffects",W),R=r(a,c,"pluginData",me),k=r(a,c,"errors",K),D=r(a,c,"warnings",K),N=r(a,c,"watchFiles",K),B=r(a,c,"watchDirs",K);Y(a,c,`from onResolve() callback in plugin ${V(v)}`),o.id=E,h!=null&&(o.pluginName=h),C!=null&&(o.path=C),F!=null&&(o.namespace=F),$!=null&&(o.suffix=$),x!=null&&(o.external=x),A!=null&&(o.sideEffects=A),R!=null&&(o.pluginData=m.store(R)),k!=null&&(o.errors=ne(k,"errors",m,v,void 0)),D!=null&&(o.warnings=ne(D,"warnings",m,v,void 0)),N!=null&&(o.watchFiles=ge(N,"watchFiles")),B!=null&&(o.watchDirs=ge(B,"watchDirs"));break}}catch(a){o={id:E,errors:[ie(a,u,m,M&&M(),v)]};break}n(p,o)},l["on-load"]=async(p,f)=>{let o={},v="",O,M;for(let E of f.ids)try{({name:v,callback:O,note:M}=j[E]);let a=await O({path:f.path,namespace:f.namespace,suffix:f.suffix,pluginData:m.load(f.pluginData),with:f.with});if(a!=null){if(typeof a!="object")throw new Error(`Expected onLoad() callback in plugin ${V(v)} to return an object`);let c={},h=r(a,c,"pluginName",y),C=r(a,c,"contents",Te),F=r(a,c,"resolveDir",y),$=r(a,c,"pluginData",me),x=r(a,c,"loader",y),A=r(a,c,"errors",K),R=r(a,c,"warnings",K),k=r(a,c,"watchFiles",K),D=r(a,c,"watchDirs",K);Y(a,c,`from onLoad() callback in plugin ${V(v)}`),o.id=E,h!=null&&(o.pluginName=h),C instanceof Uint8Array?o.contents=C:C!=null&&(o.contents=Z(C)),F!=null&&(o.resolveDir=F),$!=null&&(o.pluginData=m.store($)),x!=null&&(o.loader=x),A!=null&&(o.errors=ne(A,"errors",m,v,void 0)),R!=null&&(o.warnings=ne(R,"warnings",m,v,void 0)),k!=null&&(o.watchFiles=ge(k,"watchFiles")),D!=null&&(o.watchDirs=ge(D,"watchDirs"));break}}catch(a){o={id:E,errors:[ie(a,u,m,M&&M(),v)]};break}n(p,o)};let J=(p,f)=>f([],[]);P.length>0&&(J=(p,f)=>{(async()=>{let o=[],v=[];for(let{name:O,callback:M,note:E}of P){let a,c;try{let h=await M(p);if(h!=null){if(typeof h!="object")throw new Error(`Expected onEnd() callback in plugin ${V(O)} to return an object`);let C={},F=r(h,C,"errors",K),$=r(h,C,"warnings",K);Y(h,C,`from onEnd() callback in plugin ${V(O)}`),F!=null&&(a=ne(F,"errors",m,O,void 0)),$!=null&&(c=ne($,"warnings",m,O,void 0))}}catch(h){a=[ie(h,u,m,E&&E(),O)]}if(a){o.push(...a);try{p.errors.push(...a)}catch(h){}}if(c){v.push(...c);try{p.warnings.push(...c)}catch(h){}}}f(o,v)})()});let w=()=>{for(let p of T)setTimeout(()=>p(),0)};return _=!0,{ok:!0,requestPlugins:S,runOnEndCallbacks:J,scheduleOnDisposeCallbacks:w}};function Le(){let e=new Map,t=0;return{clear(){e.clear()},load(n){return e.get(n)},store(n){if(n===void 0)return-1;let i=t++;return e.set(i,n),i}}}function pe(e,t,n){let i,u=!1;return()=>{if(u)return i;u=!0;try{let l=(e.stack+"").split(`
`);l.splice(1,1);let g=qe(t,l,n);if(g)return i={text:e.message,location:g},i}catch(l){}}}function ie(e,t,n,i,u){let l="Internal error",g=null;try{l=(e&&e.message||e)+""}catch(s){}try{g=qe(t,(e.stack+"").split(`
`),"")}catch(s){}return{id:"",pluginName:u,text:l,location:g,notes:i?[i]:[],detail:n?n.store(e):-1}}function qe(e,t,n){let i="    at ";if(e.readFileSync&&!t[0].startsWith(i)&&t[1].startsWith(i))for(let u=1;u<t.length;u++){let l=t[u];if(l.startsWith(i))for(l=l.slice(i.length);;){let g=/^(?:new |async )?\S+ \((.*)\)$/.exec(l);if(g){l=g[1];continue}if(g=/^eval at \S+ \((.*)\)(?:, \S+:\d+:\d+)?$/.exec(l),g){l=g[1];continue}if(g=/^(\S+):(\d+):(\d+)$/.exec(l),g){let s;try{s=e.readFileSync(g[1],"utf8")}catch(b){break}let m=s.split(/\r\n|\r|\n|\u2028|\u2029/)[+g[2]-1]||"",U=+g[3]-1,P=m.slice(U,U+n.length)===n?n.length:0;return{file:g[1],namespace:"file",line:+g[2],column:Z(m.slice(0,U)).length,length:Z(m.slice(U,U+P)).length,lineText:m+`
`+t.slice(1).join(`
